...
/// списки монстров и предметов, а также точки входа и выхода.
/// </summary>
public class Level
{
    ...
    /// <summary>Все живые монстры на уровне.</summary>
    public List<Monster> Monsters { get; set; } = [];

    /// <summary>Все предметы на полу (ещё не подобранные).</summary>
